...
class AffiliateController extends Controller
{
    ...
    {
        $confirm = \App\Models\Affiliate::where('is_confirm', true)->paginate(10);
        $request = \App\Models\Affiliate::where('is_confirm', false)->where('is_cancel', false)->paginate(10);
        $cancel = \App\Models\Affiliate::where('is_cancel', true)->paginate(10);
    ...
    public function reject($id)
    {
        ...
        $affiliate = \App\Models\Affiliate::where('id', $id)->with('user')->first();
        if ($affiliate) {
    ...
    public function affiliateStatus($id)
    {
        ...
        $ins = \App\Models\Affiliate::where('user_id', $payment->user_id)->first();
        //payment
