...
rush.Game = (function() {
  ...
  function RushGame() {
    ...
    var bgImage = new createjs.Bitmap(root_url + '/public/games/rush/images/trees.png');
  ...
  p.gameOver = function(){
    ...
    // score here
    var gamer_score = this.collectedCoins;
    var gamer_url = document.getElementById('games_rush_store').value;
