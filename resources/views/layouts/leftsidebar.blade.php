            ...
            <div class="vertical-menu-detail">
                <div class="logobar">
                    <a href="{{ route('dashboard') }}" class="logo"><img
                            src="{{ filePath(getSystemSetting('type_logo')->value) }}" class="img-fluid"
                            alt="logo"></a>
                </div>
                        ...
                        <ul class="vertical-menu">
                            <li>
                                <a href="{{ route('dashboard') }}">
                                    ...
                                    <lord-icon src="https://cdn.lordicon.com/aslgozpd.json" trigger="hover"
                            ...
                            @if (\Illuminate\Support\Facades\Auth::user()->user_type == 'Admin')
                                <li
                                    class="{{ request()->is('dashboard/user*') ||
                            ...
                            <li
                                ...
                                <a href="javaScript:void();">
                                    ...
                                    <lord-icon src="https://cdn.lordicon.com/ofqzcdla.json" trigger="hover"
                                        target="a" style="width:25px; height:25px; margin-right: 5px;">
                                    </lord-icon>
                                    <span>@translate(Courses) @if (\Illuminate\Support\Facades\Auth::user()->user_type == 'Admin')
                                            <sup
                                                class="badge badge-info">{{ \App\Models\Course::where('is_published', false)->count() > 0 ? '@translate(Unpublished)' : null }}</sup>
                                        @endif
                                    </span>
                                    <i class="feather icon-chevron-right"></i>
                            ...
                            @if (couponActive() && \Illuminate\Support\Facades\Auth::user()->user_type == 'Admin')
                                <li
                                    class="{{ request()->is('dashboard/coupon*') ? 'active' : null }}">
                                    <a href="javascript:;">
                                        <!-- <i class="fa fa-bullhorn"></i> -->
                                        <lord-icon src="https://cdn.lordicon.com/webtefou.json" trigger="hover"
                                            target="a" style="width:25px; height:25px; margin-right: 5px;">
                                        </lord-icon>
                                    ...
                                    <ul class="vertical-submenu">
                                        <li>
                                            <a href="{{ route('coupon.index') }}"
                                                class="{{ request()->is('dashboard/coupon/new') ? 'active' : null }}">
                                                @translate(new Coupon())
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('coupon.all') }}"
                                                class="{{ request()->is('dashboard/coupons') ? 'active' : null }}">
...
{{--                            @endif--}}
                            ...
                            <li><a href="{{ route('tickets.index') }}"
                                    ...
                                    <lord-icon src="https://cdn.lordicon.com/uvextprq.json" trigger="hover"
                                        target="a" style="width:25px; height:25px; margin-right: 5px;">
                                    </lord-icon>
                                    <span>@translate(Support Ticket)</span>
                                </a>
                            </li>
                        ...
                        @if (env('FORUM_PANEL') == 'YES')
                                ...
                                @if (Auth::user()->user_type === 'Admin' || Auth::user()->user_type === 'Instructor')
                                    <li class="{{ request()->is('dashboard/forum*') ? 'active' : null }}">
                                        <a href="javaScript:void();">
                                            <!-- <i class="fa fa-question-circle"></i> -->
                                            <lord-icon src="https://cdn.lordicon.com/njjuilvq.json" trigger="hover"
                                                target="a" style="width:25px; height:25px; margin-right: 5px;">
                                            </lord-icon>
                                        ...
                                        <ul class="vertical-submenu">
                                            ...
                                            <li><a href="{{ route('forum.index') }}"
                                                    target="_blank">@translate(Browse
                                            Forum)</a></li>
                                        </ul>
                                    </li>
                                @endif
                                ...
                                @if (Auth::user()->user_type === 'Admin' || Auth::user()->user_type === 'Instructor')
                                    <li class="{{ request()->is('dashboard/subscription*') ? 'active' : null }}">
                                        <a href="javaScript:void();">
                                            ...
                                            <lord-icon src="https://cdn.lordicon.com/vmibgbhr.json" trigger="hover"
                                                target="a" style="width:25px; height:25px; margin-right: 5px;">
                                            </lord-icon>
