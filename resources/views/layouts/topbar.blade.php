                            ...
                            <div class="dropdown show">
                                <a class="dropdown-toggle infobar-icon" href="javascript:void()" role="button"
                                   ...
                                   aria-expanded="true"><img
                                        ...
                                        alt="notifications">
                                    <span class="live-icon">{{ App\Models\NotificationUser::where('user_id',Auth::user()->id)->where('is_read',false)->count() }}</span></a>
                                <div class="dropdown-menu dropdown-menu-right hide st-drop"
                                    ...
                                    <div class="notification-dropdown-title">
                                        <div class="row">
                                            ...
                                            @if ( App\Models\NotificationUser::where('user_id',Auth::user()->id)->where('is_read',false)->count() > 0)
                                                <div class="col-md-6">
