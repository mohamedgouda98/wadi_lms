                    ...
                    <table class="table table-bordered dataTable w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="dropdown-item text-danger" href="{{route('affiliate.reject',$item->id)}}">
                                            <i class="feather flaticon-cancel mr-2"></i>@translate(reject)</a>
                                        <a class="dropdown-item " href="{{route('affiliate.active',$item->id)}}">
            ...
            <table class="table  table-bordered table-hover text-center dataTable w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a class="dropdown-item text-danger w-0" href="{{ route('affiliate.reject', $item->id) }}">
                    ...
                    <table class="table table-bordered  dataTable w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="dropdown-item w-0" href="{{ route('affiliate.active', $item->id) }}">
                                            <i class="feather icon-check-circle mr-2"></i>@translate(Active)</a>
                                    </div>
                                </td>
