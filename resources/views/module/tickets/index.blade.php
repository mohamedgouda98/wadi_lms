            ...
            <table class="table table-striped- table-bordered table-hover text-center">
                ...
                @forelse($tickets as  $item)
                    <tr>
                        ...
                        <td>
                            {{$item->subject}}
                            @if(\App\Models\SupportTicketReplay::where('ticket_id',$item->id)->count() >0 )
                              <span class="badge badge-dark">
                                  {{\App\Models\SupportTicketReplay::where('ticket_id',$item->id)->latest()->first() != null ?\App\Models\SupportTicketReplay::where('ticket_id',$item->id)->latest()->first()->user_id == \Illuminate\Support\Facades\Auth::id() ? 'Send' : 'Replay' : null}}
                              </span>
                            @endif
                        </td>
                        <td>
