...
@section('content')
                      ...
                      <div class="single-counterup">
                          ...
                          <div class="single-counterup-content">
                              <div class="counter-number">
                                  <h3 class="title counter">{{\App\Models\User::where('user_type','Instructor')->get()->count()}}</h3>
                                  <h3 class="title">+</h3>
                              </div>
  ...
  <section class="category-section">
      <div class="container">
          ...
          <div class="row">
              @foreach(\App\Models\Category::Published()->where('is_popular', 1)->get() as $item)
  ...
  <section class="instructor-section gradient-bg">
      <div class="container">
          ...
          <div class="row">
              @foreach(\App\Models\Instructor::with('courses')->get()->shuffle()->take(3) as $instructor)
                  <div class="col-lg-3 col-md-6">
