...
{{--    {{print_r(allBlogTags())}}--}}
                                    ...
                                    <div class="course-content margin-top-30">
                                        ...
                                        <div class="course-instructor-rating margin-top-20">
                                            ...
                                            <div class="course-rating">
                                                <ul>
                                                    @for ($i = 0; $i < enrolmentStare(\App\Models\Enrollment::where('course_id',$course->id)->count()); $i++)
                                                        <li><i class="fa fa-star"></i></li>
                                                    @endfor
                                                </ul>
                                                <span>{{number_format(enrolmentStare(\App\Models\Enrollment::where('course_id',$course->id)->count()),1)}}({{\App\Models\Enrollment::where('course_id',$course->id)->count()}})</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="hover-state">
                                        ...
                                        <div class="course-info margin-top-30">
                                            <div class="course-enroll">
                                                <span>@translate(enrolled) {{\App\Models\Enrollment::where('course_id',$course->id)->count()}}</span>
                                            </div>
                                            <div class="course-video">
                                                <i class="fa fa-play-circle-o"></i>
                                                <span>{{$course->classes->count()}} @translate(lectures)</span>
                ...
                <div class="row align-items-center">
                        ...
                        <div class="single-counterup">
                            ...
                            <div class="single-counterup-content">
                                <div class="counter-number">
                                    <h3 class="title counter">{{\App\Models\User::where('user_type','Instructor')->where('verified',true)->get()->count()}}</h3>
                                    <h3 class="title">+</h3>
                                </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="single-counterup">
                            ...
                            <div class="single-counterup-content">
                                <div class="counter-number">
                                    <h3 class="title counter">{{\App\Models\Enrollment::count()}}</h3>
                                    <h3 class="title">+</h3>
                                </div>
                    ...
                    <div class="col-xl-4 col-sm-6">
                        <div class="single-counterup">
                            ...
                            <div class="single-counterup-content">
                                <div class="counter-number">
                                    <h3 class="title counter">{{\App\Models\Course::Published()->count()}}</h3>
                                    <h3 class="title">+</h3>
                                </div>
    ...
    <section class="instructor-section gradient-bg">
        <div class="container">
            ...
            <div class="row">
                @foreach(\App\Models\Instructor::with('courses')->get()->shuffle()->take(4) as $instructor)
                    @if(\App\Models\User::where('id',$instructor->user_id)->first() != null)
                    @if(\App\Models\User::where('id',$instructor->user_id)->first()->verified == true)
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="package-item package-item-active">
                                ...
                                <div class="btn-box">
                                    <a href="{{ route('subscription.frontend', $subscription->duration) }}"
                                       class="theme-btn">{{ App\Models\SubscriptionCourse::where('subscription_duration','LIKE','%'.$subscription->duration.'%')->count() }}
                                        Courses</a>
