                            ...
                            <div class="course-content margin-top-30">
                                ...
                                <div class="course-instructor-rating margin-top-20">
                                    ...
                                    <div class="course-rating">
                                        <ul>
                                            @for ($i = 0; $i < enrolmentStare(\App\Models\Enrollment::where('course_id',$item->course->id)->count()); $i++)
                                                <li><i class="fa fa-star"></i></li>
                                            @endfor
                                        </ul>
                                        <span>{{number_format(enrolmentStare(\App\Models\Enrollment::where('course_id',$item->course->id)->count()),1)}}({{\App\Models\Enrollment::where('course_id',$item->course->id)->count()}})</span>
                                    </div>
                                </div>
                            ...
                            <div class="hover-state">
                                ...
                                <div class="course-info margin-top-30">
                                    <div class="course-enroll">
                                        <span>@translate(enrolled) {{\App\Models\Enrollment::where('course_id',$item->course->id)->count()}}</span>
                                    </div>
                                    <div class="course-video">
                                        <i class="fa fa-play-circle-o"></i>
                                        <span>{{$item->course->classes->count()}} @translate(lectures)</span>
