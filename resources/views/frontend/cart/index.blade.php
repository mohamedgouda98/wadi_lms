                        ...
                        <div class="shopping-cart-content pt-2">
                            <ul class="list-items">
                                <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">
                                    ...
                                    <span class="primary-color-3"> <del>{{formatPrice($total_price)}}</del>
                                        {{formatPrice($total_price - couponDiscountPrice($coupon))}}</span>
                            ...
                            <div class="card-box-shared">
                                ...
                                <div class="card-box-shared-body p-0">
                                    ...
                                    <div class="payment-method-wrap">
                                        <div class="checkout-item-list">
                                            ...
                                            <div class="accordion" id="paymentMethodExample">
                                                                    ...
                                                                    <div class="input-box">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                placeholder="MM" required="" name="text"
                                                                                type="text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="input-box">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control card-expiry-year"
                                                                                placeholder="YY" required="" name="text"
                                                                                type="text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="input-box">
                                                ...
                                                env('PAYTM_ACTIVE') != "NO" && paytmRouteForBlade())
                                                {{--PAYTM--}}
                                                ...
                                                <form action="{{ route('paytm.payment') }}" method="POST"
                                                    ...
                                                    @if(Session::has('coupon'))
                                                    <input type="hidden" name="amount"
                                                        value="{{ PaytmPrice($total_price - couponDiscountPrice($coupon)) }}">
                                                    @else
                                                    <input type="hidden" name="amount"
                                                    ...
                                                    <div class="card border-bottom-0 paytm-top">
                                                        <div class="card-header">
                                                            <div
                                                                class="checkout-item d-flex align-items-center justify-content-between">
                                                                <span
                                                                    class="widget-title font-size-18 stripe-btn w-75 d-block text-center font-weight-bold m-auto">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary">
                                                            ...
                                                            <input type="hidden" name="amount"
                                                                ...
                                                                Pay {{ formatPrice($total_price - couponDiscountPrice($coupon)) }}
                                                            @else
                                                            <input type="hidden" name="amount"
                                                                value="{{ PagarPrice($total_price) }}">
                                                                Pay {{ formatPrice($total_price) }}
                                                            @endif
                                                        </button>
                                                    </div>
                                                </form>
                                    ...
                                    <form id="paypal-form" method="post" action="{{route('paypal.paymnet')}}"
                                        class="invisible">
                                        @csrf
                                        ...
                                        @if(Session::has('coupon'))
                                        <input type="hidden"
                                            value="{{PaypalPrice($total_price- couponDiscountPrice($coupon))}}"
                                            name="amount" id="amount">
                                        @else
                                        <input type="hidden" value="{{PaypalPrice($total_price)}}" name="amount"
                                            id="amount">
                                        @endif
                                    </form>
                                </div><!-- end accordion -->
