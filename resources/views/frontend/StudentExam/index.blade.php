                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content my-courses-bread-content">
                        <div class="section-heading">
                            <h2 class="section__title">@translate(My Exam)</h2>
                        </div>
                                                ...
                                                <div class="col-lg-4 column-td-half">
                                                    <div class="card-item">
                                                        <div class="card-image">
                                                            <a href="{{route('lesson_details',$exam->course->slug)}}"
                                                               class="card__img">
                                                                <img src="{{filePath($exam->course->image)}}"
                                                                     alt="{{$exam->course->title}}">
                                                            </a>
                                                        </div><!-- end card-image -->
                                                        <div class="card-content p-4">
                                                            <h3 class="card__title mt-0">
                                                                <a href="{{route('course.single',$exam->course->slug)}}">{{Str::limit($exam->course->title,58)}}</a>
                                                            </h3>
                                                            <div class="text-center mt-3">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <a href="{{ route('student-exam.questions',$exam) }}"
