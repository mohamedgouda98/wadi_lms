<div class="header-menu-content bg-danger">
    <div class="container">
...
<ul class="nav justify-content-center py-1 fixed-bottom bg-white btm-fixed-nav d-none">
  <li class="nav-item">
    <div class="notification-item mr-3">
      <a href="{{ route('shopping.cart') }}">
        <button class="notification-btn dropdown-toggle">
          <i class="la la-shopping-cart fs-2"></i>
            <span class="quantity cart-quantity">{{ App\Models\Cart::where('user_id',Auth::user()->id)->count() }}</span>
        </button>
      </a>
    </div>
