                                ...
                                <div class="col-lg-12 column-td-half">
                                    <div class="team-single-item">
                                        ...
                                        <p class="number-count">
                                            <span
                                                class="counter">{{ App\Models\Course::where('user_id',$instructor->user_id)->count() }}</span>
                                        </p>
                                        ...
                                        <div class="rating-wrap d-flex mt-2 mb-3">
                                                    <span class="star-rating-wrap">
                                                     @translate(Enrolled) <span
                                                            class="star__count">{{\App\Models\Enrollment::where('course_id',$i_course->id)->count()}}</span>
                                                  </span>
                                        </div><!-- end rating-wrap -->
                                ...
                                <div class="card-item">
                                    <div class="card-content">
                                        ...
                                        <div class="rating-wrap d-flex mt-2 mb-3">
                                                                ...
                                                                <span class="star-rating-wrap">
                                                         @translate(Enrolled) <span
                                                                        class="star__count">{{\App\Models\Enrollment::where('course_id',$i_tooltip->id)->count()}}</span>
                                                    </span>
                                        </div><!-- end rating-wrap -->
