                                            ...
                                            <li>
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="chb23">@translate(All)<span
                                                            class="ml-2 font-size-14 course-hvr">({{\App\Models\Course::Published()->get()->count()}})</span></label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="chb24">@translate(Free)<span
                                                            class="ml-2 font-size-14 course-hvr">({{\App\Models\Course::Published()->where('is_free',true)->get()->count()}})</span></label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="chb25">@translate(Paid)<span
                                                            class="ml-2 font-size-14 course-hvr">({{\App\Models\Course::Published()->where('is_free',false)->get()->count()}})</span></label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
