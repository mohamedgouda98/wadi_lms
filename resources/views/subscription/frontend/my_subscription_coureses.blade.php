                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content my-courses-bread-content">
                        <div class="section-heading">
                            <h2 class="section__title">@translate(My Subscription Courses)</h2>
                        </div>
                                                ...
                                                <div class="col-lg-4 column-td-half">
                                                    <div class="card-item">
                                                        <div class="card-image">
                                                            <a href="{{route('lesson_details',$item->course->slug)}}"
                                                               class="card__img">
                                                        ...
                                                        <div class="card-content p-4">
                                                                    ...
                                                                    <div class="skillbar-box mt-1">
                                                                        <div class="skillbar">
                                                                            <div class="skillbar-bar skillbar-bar-1"
                                                                                 style="width: {{\App\Http\Controllers\Traits\StudentTraits::seenCourse($item->id,$item->course->id) }}%;"></div>
                                                                        </div> <!-- End Skill Bar -->
                                                                    </div>
                                                                    <div
                                                                        class="skill-bar-percent">{{\App\Http\Controllers\Traits\StudentTraits::seenCourse($item->id,$item->course->id)}}
                                                                        %
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="text-center mt-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <a href="{{ route('subscription.lesson.details',$item->course->slug) }}"
