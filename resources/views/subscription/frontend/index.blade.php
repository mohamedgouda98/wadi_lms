                                                ...
                                                <div class="column-td-half">
                                                    ...
                                                    <span class="star-rating-wrap">
                                                     @translate(Enrolled) <span
                                                            class="star__count">{{\App\Models\Enrollment::where('course_id',$course->course->id)->count()}}</span>
                                                  </span>
                                                            </div><!-- end rating-wrap -->
                                                ...
                                                <div id="tooltip_content_{{$c_tooltip->course->id}}">
                                                    <div class="card-item">
                                                        <div class="card-content">
                                                            ...
                                                            <span class="star-rating-wrap">
                                                     @translate(Enrolled) <span
                                                                    class="star__count">{{\App\Models\Enrollment::where('course_id',$c_tooltip->course->id)->count()}}</span>
                                                </span>
                                                            </div><!-- end rating-wrap -->
