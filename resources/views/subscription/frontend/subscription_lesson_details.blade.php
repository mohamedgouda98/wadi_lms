                                            ...
                                            <div class="lecture-overview-stats-wrap d-flex ">
                                                ...
                                                <div class="lecture-overview-stats-item">
                                                    <ul class="list-items">
                                                        ...
                                                        <li>
                                                            <span>@translate(Students):</span>{{\App\Models\Enrollment::where('course_id',$s_course->id)->count()}}
                                                        </li>
                                                ...
                                                <div class="course-dashboard-side-content">
                                                    <div class="accordion course-item-list-accordion"
                                                        ...
                                                        <div class="container p-5">
                                                            <div class="progress" data-percentage="{{\App\Http\Controllers\Traits\StudentTraits::seenCourse($enroll->first()->id,$s_course->id)}}">
            <span class="progress-left">
                ...
                <span class="progress-bar"></span>
                                                                ...
                                                                <div class="progress-value">
                                                                    <div>
                                                                        {{\App\Http\Controllers\Traits\StudentTraits::seenCourse($enroll->first()->id,$s_course->id)}}%<br>
                                                                        <span>completed</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        @if(\App\Http\Controllers\Traits\StudentTraits::seenCourse($enroll->first()->id,$s_course->id) == number_format(100))
