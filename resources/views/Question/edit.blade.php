...
@section('content')
    ...
    <div class="card m-b-30">
        <h4 class="card-header">@translate(Update Question)</h4>
        <div class="card-body mx-3">
            <form action="{{ route('question.update', $examQuestion) }}" method="post">
                @method('PUT')
                @include('Question.inc._form')
                <input type="hidden" name="exam_id" value="{{ $examQuestion->exam_id }}">
                {{-- Submit --}}
